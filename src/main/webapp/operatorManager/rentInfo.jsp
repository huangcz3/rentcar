    ...
    <form class="form form-horizontal" id="form-admin-add" action="addRentInfo" method="post">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${renttable.rentid}" placeholder="" id="rentid"
                       name="rentid" readonly="readonly">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${renttable.imprest}" placeholder="" id="imprest"
                       name="imprest">
            </div>
            <%--<span id="depositd" style="float: left;padding-left: 100px;color: orange;">当前汽车押金：${carinfo.deposit} </span>--%>
        </div>

        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>当前汽车押金：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${carinfo.deposit}" placeholder="" id="depositd"
                       name="imprest">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" onfocus="WdatePicker({ dateFmt:'yyyy-MM-dd HH:mm',minDate:'%y-%M-%d'})"
                       id="begindate" name="begindate" class="input-text Wdate" readonly="readonly">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text"
                       onfocus="WdatePicker({ dateFmt:'yyyy-MM-dd HH:mm',minDate:'#F{$dp.$D(\'begindate\')}' })"
                       id="shouldreturndate"
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text"
                       onfocus="WdatePicker({ dateFmt:'yyyy-MM-dd HH:mm',minDate:'#F{$dp.$D(\'begindate\')}' })"
                       id="returndate" name="returndate" class="input-text Wdate" readonly="readonly">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${renttable.custid}" placeholder="" id="custid"
                       name="custid">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${renttable.username}" placeholder="" id="username"
                       name="username">
            </div>
        </div>
