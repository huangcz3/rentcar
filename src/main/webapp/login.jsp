    ...
    <form class="form form-horizontal" action="login" method="post">
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          ...
          <img id="img" src="/authImage" width="107px" height="38px"  onclick="changeImg()" /> <a id="kanbuq" href="javascript:;">看不清，换一张</a> </div>
      </div>
      <div class="row cl">
...
<div class="footer">Copyright BS by HCZ </br>HCZ </div>
